import sys
sys.path.append("/workspace/gaussian-opacity-field/segment-anything")
...
def create_mask_generator():
    sam_checkpoint = "/workspace/gaussian-opacity-field/segment-anything/sam_vit_h_4b8939.pth"
